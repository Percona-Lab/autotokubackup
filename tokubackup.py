...
def check_file_content(file):
    ...
    config_keys = ["mysql", "user", "port", "password", "socket", "host", "datadir", "backupdir"]
...
@click.option('--defaults_file', default='/etc/tokubackup.conf', help="Read options from the given file")
